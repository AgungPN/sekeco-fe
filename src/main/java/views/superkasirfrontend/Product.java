...
public class Product extends javax.swing.JFrame {
    ...
    public void setTable() {
        Http http = new Http();
        String endpoint = "products?" + Helpers.mapToQueryString(Map.of(
                "size", "10",
                "page", String.valueOf(page),
                "search", txtsearch.getText()
        ));
        ProductsPagination products = http.sendGetRequest(endpoint, ProductsPagination.class);
        totalPages = products.totalPages;

        String[] fields = new String[]{
                "No", "Barcode", "Nama Barang", "Harga Jual", "Profit Sharing Amount", "Stock"};
    ...
    public Long getProductSelectedId() {
        ...
        return (Long) tableProduct.getValueAt(row, 0);
    }
    ...
    private void BtnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDeleteActionPerformed
        ...
        Long productId = getProductSelectedId();
        Http http = new Http();
        UniverseResponse response = http.delete("products/" + Long.toString(productId), UniverseResponse.class);
